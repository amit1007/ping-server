...
pinglogger.pingloggerSystem.info("We are now in Triggered Alerts --->FilterHyperCube")
...
var Matrix = function (appid,qdefM,filterparameter,UserID,callback){
        pinglogger.pingloggerSystem.info("Filter Trigger");
        ...
        function(err, res, body) {
            ...
            r.get(hub + ticket, function(error, response, body) {
                ...
                applyFilters(appid,qdefM,filterparameter).then(value => {
                ...
                function applyFilters(appid,qdefM,ss) {
                    ...
                    console.log("selectValFilter");console.log(selectValFilter);
