    ...
    mail : function(alertby,mess){
        ...
        if(alertby == "measures" || alertby == "filter" ){
            ...
            if(alertby == "measures"){               
                ...
                subject = " PING : "+messFilterBody.CurrentValue.length+" \t "+messFilterBody.qliksenseurl.diamention+" with "+messFilterBody.Measures+" \t "+messFilterBody.threshold+" !";
        ...
        var transporter = nodemailer.createTransport({
            ...
            transporter.sendMail(mailOptions, function(error, info){
                if (error) {
                    ...
                    console.log(mess.alertname+"send"+info.response);
